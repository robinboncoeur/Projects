...
1. **Don’t fight for the old channel as the only battlefield.**
   Make it unofficial, then make it irrelevant.

2. **Move through committee authority.**
   A formal resolution matters. It turns “we’re annoyed with him” into “the Society has determined its official communications channels.”

3. **Document first, contact second.**
   Screenshots, URLs, dates, admin status, offending posts, member confusion — all before he has warning and starts deleting or editing things.

4. **Avoid public mud-wrestling.**
   The Society should look calm, legitimate, and adult. Let him look like the nuisance if he insists on performing.
