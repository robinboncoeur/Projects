...
I guess what set it off was trying to upload images to a GMail email I was sending to Martin and Esther on 2022-Apr-15. Got about halfway through and GMail told me I would exceeded the size limit (25mb). Which seems silly. And this is without trying to send a video, even. Just pictures.
...
You will notice that dates sort-of from the link key. For example, I'll give whoever I'm writing an email to, as a link, the current entry into a give project page, like so::

	https://robinboncoeur.github.io/Projects/RSTs/Garden.html#apr-23
	
Sphinx is really good that way! By the way, the images have been uniformly resized (for the most part) to 1024 x 768 pixels. They are not displayed in that resolution, but right-clicking and choosing "Open image in a New Tab..." will display that image in full resolution. 
